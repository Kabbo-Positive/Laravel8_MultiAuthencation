...
<header class="header_area">
    ...
    <div class="sidebar_logo">
        <a href="index.html">
    <img src="{{ asset('admin/assets/images/logo.png') }}" alt="" class="img-fluid logo1">
    ...
    <ul class="header_menu">
            ...
            <div class="dropdown_wrapper messages_item dropdown-menu dropdown-menu-right">
                ...
                <ul class="dropdown_body nice_scroll scrollbar">
                    <li>
                        <a href="#">
                            <div class="img-part">
                                <img src="{{ asset('admin/assets/images/user1.jpg') }}" alt="" class="img-fluid">
                            </div>
                            <div class="text-part">
        ...
        <li><a data-toggle="dropdown" href="#"><i class="far fa-user"></i></a>
                <div class="user_item dropdown-menu dropdown-menu-right">
                    <div class="admin">
                        <a href="#" class="user_link"><img src="{{ asset('admin/assets/images/admin.jpg') }}" alt=""></a>
                    </div>
                <ul>
